...
pub struct CreateOrgRequest {
    ...
    #[serde(rename = "enable_auto_joining_by_domain", skip_serializing_if = "Option::is_none")]
    pub enable_auto_joining_by_domain: Option<bool>,
    #[serde(rename = "members_must_have_matching_domain", skip_serializing_if = "Option::is_none")]
